...
namespace QuanLyBanGiay
{
    public partial class frmDMHangHoa : Form
    {
        ...
        private void LoadDataGridView()
        {
            ...
            DataGridView.Columns[0].HeaderText = "Mã giày";
            DataGridView.Columns[1].HeaderText = "Tên giày";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            if (txtAnh.Text.Trim().Length == 0)
            {
                MessageBox.Show("Bạn phải ảnh minh hoạ cho giày", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtAnh.Focus();
                return;
            }
